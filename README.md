 ...
 **A LA HORA DE HACER LAS NUEVAS LOGICAS DE NEGOCIO ES CLAVE UTILIZAR LO DE LAS RELACIONES POR QUE SI NO PARA MODIFICAR UNA RELACION TIENES QUE CREAR UNA FUNCION PARA CADA UNA (MUY MALO REPETIR CODIGO), LO TENEIS HECHO EN USERS.TS EN LA CARPETA SERVICES, MIRARLO QUE ES CLAVE**

 **CREAR TESTS ES CLAVE POR QUE ES MEGA FACIL Y ASI NOS ASEGURAMOS DE QUE TODO VA PERFECTO, HAY UNO CREADO YA EN LA CARPETA TEST, PARA EJECUTARLO ES NPM RUN TEST, MIRARLO Y HACED LOS QUE OS TOQUEN, EJECUTAR TODO EN LA TERMINAL DEL DOCKER SI NO NO VA BIEN POR TEMAS DE QUE LA IP A LA BD ES UNA .ENV PARA MAYOR PRIVACIDAD**
...
- `npm run test` - Ejecuta todos los tests que tenemos en la carpeta tests (Esto es clave)
